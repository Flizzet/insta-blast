var cellPrices = [ 4, 6, 15, 25, 40, 80, 100, 500];
var cellAmounts = [ 500, 1000, 3000, 5000, 10000, 50000, 100000, 1000000 ];
...
$(document).ready(function() {
	...
	for (var i = 0; i < cells.length; i++) {
		...
		e.html('<div class="title">' + c.FollowerCount + ' Plays</div><div class="price">$' + c.Price + '</div>');
